...
public class Detail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AppoNet().getAppoListByLab_no(this, handler, lab_no);
        new UserNet().getTeacherByLab_no(this, lab_no, handler);
    }


  
    private void setTeacherMessage() {
		// TODO Auto-generated method stub
		TextView tv=(TextView) this.findViewById(R.id.detail_teacher_message);
		try {
			tv.setText("管理教师："+jo.getString("name")+'\t'+"手机："+jo.getString("phone"));
    ...
    private void setAdapter(){
    	...
    	SimpleAdapter adapter=new SimpleAdapter(this, list, R.layout.detail_list_item,
    			new String[]{"date","date_part","name","number","pass_status","classes","phone"}, 
    			new int[]{R.id.detail_item_date,R.id.detail_item_date_part,R.id.detail_name,
    			R.id.detail_item_number,R.id.detail_item_status,R.id.detail_item_classes,
